 ...
 *
 * Return: converted integer, -1 if error occurs
 */
 ...
 * @estr: char pointer containing specified error type
 *
 * Return: converted integer, -1 if error occurs
 */
...
/**
 * print_d - function that prints a number in base 10
 * @input: number input
 * @fd: filedescriptor to write the number to
 *
 ...
 * @buf: pointer to the the string to be modified
 *
